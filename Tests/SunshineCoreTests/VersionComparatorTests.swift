...
@Suite struct VersionComparatorTests {
    ...
    @Test func prereleaseIdentifiersOrderBySemverRules() {
        ...
        #expect(AppVersion(shortVersion: "1.0.0-beta.2").isUpdate(AppVersion(shortVersion: "1.0.0-beta.10")))
        ...
        #expect(AppVersion(shortVersion: "1.0.0-beta").isUpdate(AppVersion(shortVersion: "1.0.0-beta.1")))
        // Alphanumeric identifiers compare lexically.
        #expect(AppVersion(shortVersion: "1.0.0-alpha").isUpdate(AppVersion(shortVersion: "1.0.0-beta")))
    }
